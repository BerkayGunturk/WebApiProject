        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SocailMedia1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SocailMedia2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SocailMedia3 = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
